...
export function ConnectionBanner({ status, error, retryCount, onRetry }: ConnectionBannerProps) {
  ...
  if (status === 'stopped') {
    return (
      <div className="flex items-center justify-between gap-3 rounded-[var(--radius-md)] bg-bg-elevated border border-border-default px-4 py-3 text-sm text-text-secondary mb-4">
  ...
  if (status === 'connecting' && retryCount > 0) {
    return (
      <div className="flex items-center gap-3 rounded-[var(--radius-md)] bg-warning-subtle border border-warning-muted px-4 py-3 text-sm text-text-primary mb-4">
  ...
  if (status === 'error') {
    return (
      <div className="flex items-center justify-between gap-3 rounded-[var(--radius-md)] bg-danger-subtle border border-danger-muted px-4 py-3 text-sm text-text-primary mb-4">
        <span>
